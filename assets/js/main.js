...
function defUpperStr(str) {
  var newString = str || "DEFAULT TEXT";
  return newString.toUpperCase();
}
console.log(defUpperStr("123ghfghf"));
console.log(defUpperStr());
console.log(defUpperStr("GFGFGFGFG"));
...
function cbRandom(a, b) {
  var result;
  result = Math.ceil(Math.random() * (a - b) + b);
  console.log(`случайное число в диапазоне между ${a} и ${b} =`);
  return result;
}

console.log(mainFunc(3, 5, cbPow));
console.log(cbPow(5, 3));
console.log(mainFunc(3, 5, cbAdd));
